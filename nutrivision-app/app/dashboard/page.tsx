...
import CaloriHarianColumn from "@/components/CaloriHarianColumn";
import NutriScoreTrendColumn from "@/components/NutriScoreTrendColumn";
            ...
            <div className="flex-1 px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-14">
                <div className="mx-auto w-full max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[4fr_5fr_3fr] gap-6 md:gap-8 mb-8">
                        ...
                        <NutriScoreTrendColumn
                            loading={loading}
                            nutriScoreTrend={data?.nutriScoreTrend}
                        />
                    </div>
                </div>
            </div>
